...
export const HorizonHero = () => {
  ...
  useEffect(() => {
    const initThree = () => {
      ...
      refs.scene.fog = new THREE.FogExp2(0x0F172A, 0.00025);
    ...
    const createMountains = () => {
      const { current: refs } = threeRefs;
      const layers = [
        { distance: -50, height: 60, color: 0x064E3B, opacity: 1 },
        { distance: -100, height: 80, color: 0x0F766E, opacity: 0.8 },
        { distance: -150, height: 100, color: 0x134E4A, opacity: 0.6 },
      ...
      const material = new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            vec3 atmosphere = vec3(0.64, 0.90, 0.21) * intensity; // Lime Green #A3E635 approx
    ...
    return (
      <>
        {parts[0].split('').map((char, i) => (
          <span key={`p1-${i}`} className="title-char">
            {char}
          </span>
        ))}
        <span className="title-char text-primary">.</span>
        {parts[1].split('').map((char, i) => (
          <span key={`p2-${i}`} className="title-char text-primary">
            {char}
          </span>
        ))}
      </>
  ...
  return (
    <div ref={containerRef} className="hero-container">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: 'hidden' }}>
        ...
        <div className="vertical-text">VERIFY</div>
      </div>

      <div className="hero-content">
        <h1 ref={titleRef} className="hero-title">
          {splitTitle("txn.Verify")}
        </h1>
        
        <div ref={subtitleRef} className="hero-subtitle">
          <p className="subtitle-line">
            Real-time intelligence for digital transactions,
          </p>
          <p className="subtitle-line">
      ...
      <div ref={scrollProgressRef} className="scroll-progress" style={{ visibility: 'hidden' }}>
        <div className="scroll-text text-xs tracking-[0.3em]">SCROLL</div>
        ...
        <div className="section-counter text-xs">
